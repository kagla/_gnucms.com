  ...
  <div class="card-body">
    ...
    <form method="post" action="<?= $this->url('comments.edit', ['id' => $comment['id']]) ?>">
      ...
      <fieldset class="fieldset<?php if (array_key_exists('content', $errors)): ?> is-invalid<?php endif ?>">
        ...
        <textarea class="textarea textarea-bordered textarea-block" id="comment-edit-content" name="content" rows="5" data-required="1"><?= $this->e($values['content'] ?? $comment['content']) ?></textarea>
