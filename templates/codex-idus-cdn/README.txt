...
포함합니다. 정적 스타일은 public/themes/codex-idus-cdn/theme.css 한 파일로 동작하며 별도
npm 빌드가 필요 없습니다.
...
관리 콘솔 → 사이트 설정 → 템플릿에서 codex-idus-cdn를 선택하고 저장합니다.

테마 파일
---------

templates/codex-idus-cdn/                 화면별 Twig 템플릿
public/themes/codex-idus-cdn/theme.css    공통 토큰, 컴포넌트, 반응형 및 관리자 스타일
