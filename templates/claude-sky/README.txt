...
컴포넌트는 daisyUI 5 를 CDN 에서 그대로 받아 씁니다.
    ...
    claude-sky    이 테마. 하늘빛 블루 + daisyUI 5 CDN.

둘 중 무엇을 고를까
-------------------
- 바깥 네트워크가 막혀 있거나, 의존을 하나도 두고 싶지 않다 → claude-idus (주황)
- daisyUI 를 진짜로 쓰고 싶고 앞으로 버전을 올려 가며 쓰겠다 → claude-sky (하늘빛)
...
버전은 5.7.22 로 못박았습니다. 올릴 때는 layout.html.twig 의 링크만 고칩니다.
  ...
  ⚠ CDN 을 못 받는 곳(사내망·오프라인)에서는 컴포넌트 스타일이 빠집니다.
    ...
    모양은 무너집니다. 그런 환경이라면 둘 중 하나를 고르세요.
      ...
      2) daisyui.css 를 내려받아 public/themes/claude-sky/ 에 두고
...
구성
----
templates/claude-sky/layout.html.twig   daisyUI CDN 링크 + 공개 화면 셸
...
public/themes/claude-sky/theme.css           하늘빛 팔레트와 전용 화면 (약 1,580줄)
